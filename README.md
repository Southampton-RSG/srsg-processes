...
All proposed and actual changes must follow the Terms of Reference for the Process Working Group, detailed at [`srsg-process/context_of_the_organisation/tor_process_working_group.md`](./srsg-process/context_of_the_organisation/tor_process_working_group.md).