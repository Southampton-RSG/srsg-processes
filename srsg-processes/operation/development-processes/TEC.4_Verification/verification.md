...
- **The verification methods used to satisfy a requirement**, as indicated in each requirement issue.  In more complex cases this should take the form of a traceability matrix in a table, with methods on one axis and requirements on the other, marking individual cells for a given method used to verify a requirement.  
